...
export function PetList({ onGoToPetDetail }) {
    ...
    return <div>
        <ul className="flex flex-col gap-2 mt-2">
            {pets.map(pet => <li data-pet-id={pet.id} className="flex items-center border-2 border-black p-2 justify-between" onClick={handleGoToPetDetailClick}>
                ...
                <Button data-pet-id={pet.id} className="justify-self-end" onClick={handleRemovePetClick}>🗑️</Button>
            </li>)}
        </ul>
